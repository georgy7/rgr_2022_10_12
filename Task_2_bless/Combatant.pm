...
# Стандартная атака данного персонажа в текущем состоянии.
# Метод принимает один аргумент — противника, тоже участника сражения.
# Должен быть переопределён у всех боевых персонажей.
sub attack { }
